...
Project Atlas no longer includes BAT files for users to self-generate texture atlases. Texture artists should include their own atlases on their mods. 
...
======= Changelog =======
Version 0.7.5
	Applied fixes from ex_hlaalu_b_13.nif to ex_hlaalu_b_15.nif
Version 0.7.4
