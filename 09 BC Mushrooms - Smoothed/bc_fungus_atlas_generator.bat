...
for /f %%i in ('magick convert tx_bc_fungusbottom_01.dds -format %%w info:') do set resolutionW=%%i
set /A resolutionW=%resolutionW%/%resize%

magick convert tx_bc_fungusbottom_01.dds tx_bc_fungustop_01.dds tx_bc_fungustop_02.dds tx_bc_fungusbottom_02.dds -resize %resolutionW% -append -define dds:compression=dxt1 ATL/tx_bc_fungus_atlas.dds
