...
magick convert tx_hlaalu_doorplank_01.dds -resize %resolutionW% -append ATL/temp3.bmp

magick convert ATL/temp1.bmp tx_hinge_02.dds ATL/temp2.bmp tx_metal_strip_02.dds tx_velothi_doorstrip_01.dds ATL/temp3.bmp tx_velothi_door_01.dds tx_hlaalu_door_02.dds tx_hlaalu_door_01.dds -gravity southwest -background "#26261b" -append -resize %resolutionW% -extent x%resolutionH% -define dds:compression=dxt1 ATL/atlas_doors_01.dds
