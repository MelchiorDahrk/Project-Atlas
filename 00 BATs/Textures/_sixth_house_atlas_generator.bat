...
magick convert tx_metal_6th_top.dds tx_metal_6th_bells_top.dds tx_metal_6th_bells.dds tx_glass_obsidian.dds ATL/temp3.bmp ATL/temp4.bmp ATL/temp5.bmp ATL/temp5.bmp tx_stone_6th_trim_01.dds tx_metal_6th_strip_01.dds tx_metal_6th_strip_01.dds tx_wood_6th_blacktrim.dds tx_wood_6th_redtrim_01.dds tx_wood_6th_redtrim.dds ATL/temp6.bmp -append -resize %resolutionW% -define dds:compression=dxt1 ATL/atlad_6th.dds
...
magick convert tx_glass_6th_ashaltar.dds ATL/temp8.bmp ATL/temp7.bmp tx_glass_obsidian_strip.dds tx_stone_6th_trim_02.dds -background "#312c28" -append -resize %resolution2% -extent x%resolutionH% -define dds:compression=dxt1 ATL/atlad_6th01.dds
