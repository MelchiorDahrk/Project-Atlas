...
magick convert tx_colony_floor02.dds ATL/temp10.bmp -background "#180800" -gravity northwest -append ATL/tempx.bmp

magick convert ATL/temp2.bmp tx_colony_wood03.dds tx_colony_wood04.dds tx_colony_wood08.dds ATL/temp11.bmp ATL/temp3.bmp ATL/temp4.bmp tx_colony_wood11.dds tx_colony_wood09.dds tx_colony_wood15.dds ATL/temp5.bmp tx_colony_woodpanel03.dds ATL/temp7.bmp ATL/temp8.bmp ATL/temp9.bmp tx_colony_floor01.dds ATL/tempx.bmp -background "#180800" -gravity northwest -resize %resolutionW% -append -extent x%resolutionH% -define dds:compression=dxt1 ATL/atlad_colony_wood.dds
...
magick convert tx_colony_roof.dds ATL/temp14.bmp tx_colony_roof04.dds ATL/temp13.bmp tx_colony_icecles01.dds tx_colony_icecles02.dds -background "rgba(0, 0, 0, 0.0)" -resize %resolutionW% -append -extent x%resolutionH% -define dds:compression=dxt5 ATL/atlad_colony_roof.dds
...
magick convert ATL/temp17.bmp tx_colony_stone01.dds tx_colony_stone01.dds tx_colony_stone02.dds tx_colony_stone03.dds tx_colony_stone03.dds -background "#5a5b56" -resize %resolutionW% -append -extent x%resolutionH% -define dds:compression=dxt1 ATL/atlad_colony_rock.dds
