...
magick convert ATL/temp1.bmp tx_metal_strip_02.dds ATL/temp6.bmp tx_wood_oldwood_metal.dds tx_wood_oldwood_panel_01.dds ATL/temp2.bmp tx_wood_oldwood_corner.dds tx_wood_oldwood_design.dds ATL/temp8.bmp tx_wood_swirlwood_chest.dds tx_wood_swirlwood_trim_02.dds tx_wood_swirlwood_trim_01.dds tx_wood_swirlwood_trim.dds ATL/temp4.bmp tx_wood_swirlwood_leg.dds tx_wood_swirlwood_design.dds tx_wood_swirlwood.dds tx_wood_swirlwood.dds -gravity southwest -background "#2e2518" -append -resize %resolutionW% -extent x%resolutionH% -define dds:compression=dxt1 ATL/atlas_de_furniture.dds
